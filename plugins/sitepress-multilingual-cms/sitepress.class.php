...
class SitePress extends WPML_WPDB_User implements
	...
	function js_load() {
		...
		if ( is_admin() && ! defined( 'DOING_AJAX' ) ) {
			...
			wp_register_script( 'sitepress-scripts', ICL_PLUGIN_URL . '/res/js/scripts.js', array( 'jquery', 'jquery-ui-dialog' ), ICL_SITEPRESS_VERSION );
	...
	function copy_custom_fields( $post_id_from, $post_id_to ) {
		...
		if ( $custom_fields_from && $custom_fields_to ) {
